...
void main(void)
{
    ...
    CMCON = 0x07;
    ADCON1bits.PCFG3 = 0, ADCON1bits.PCFG2 = 1, ADCON1bits.PCFG1 = 1;



    Lcd_inicio_8bits();

    Lcd_print_string(6,"Reloj",5,"Digital");
